...
static inline void
tvsub(struct timeval *x, struct timeval *y, struct timeval *out)
{
 ...
 */
void
probe_time_start(struct timestamp *ts)
{
 ...
 */
float
probe_time_end(struct timestamp *ts)
{
    struct timeval tv;
...
void benchmark(const char* kind, int repetitions, size_t size,
        alloc_function alloc, free_function free,
        benchmark_function write_x_buffer,
        benchmark_function mutate_x_buffer,
        benchmark_function read_x_buffer,
        benchmark_function free_x_buffer);

void special_free_shim(int*ptr, size_t size) {
    special_free(ptr);
}
...
int main(int argc, char **argv)
{
    ...
    benchmark("manual", repetitions, size, malloc, free, write_manual_buffer, mutate_manual_buffer, read_manual_buffer, free_manual_buffer);
    benchmark("zerocopy", repetitions, size, special_alloc, special_free, write_special_buffer, mutate_special_buffer, read_special_buffer, NULL);
}

void benchmark(const char* kind, const int repetitions, const size_t size, alloc_function alloc, free_function free, benchmark_function write_x_buffer,
               benchmark_function mutate_x_buffer, benchmark_function read_x_buffer,
               benchmark_function free_x_buffer)
{
