...
ava_type(CpaFlatBuffer) {
  ...
  ava_field(pData) {
    ...
    ava_lifetime_static;
    // AMP: If ava_{in,out}put were value annotations they should be placed here in a sense. However they would actually
    // need to be added at the call. Which is pain, but #define will help.
  }
}
