...
/**
 * This spec contains CUDA libraries except libcuda and libcudart and can be shared
 * for TensorFlow, ONNXruntime and PyTorch CUDA specifications.
 *
 * Compile by
 * ./nwcc samples/cudnn/cudnn.v7.c -I /usr/local/cuda-10.1/include -I headers `pkg-config --cflags glib-2.0`
 *
 * Dependencies:
